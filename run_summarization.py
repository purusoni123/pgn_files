...
def runfiles(datapath, vocabpath, logroot, mode, datafiles):
  ...
  tf.app.flags.DEFINE_string('exp_name', 'pretrained_model', 'Name for experiment. Logs will be saved in a directory with this name, under log_root.')
...
def main(datafiles):
  ...
  if hps.mode == 'train':
    ...
    decoder = BeamSearchDecoder(model, batcher, vocab, datafiles)
    decoder.decode() # decode indefinitely (unless single_pass=True, in which case deocde the dataset exactly once)
  else:
    raise ValueError("The 'mode' flag must be one of train/eval/decode")

if __name__ == 'runfiles':
  tf.app.run()
